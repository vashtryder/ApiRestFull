...
@section('contenido')
    ...
    <form method="POST" action="{{ route('anio.update', $datos->id ) }}">
        @csrf
        @method('PUT')
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="row register-form">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nom_anio" name="nom_anio" placeholder="Año Academico" required="" value="{{ $datos->nom_anio }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row register-form">
                                ...
                                <div class="col-md-12"><button type="submit" class="redondo btn btn-info"><i class="fas fa-save"></i> Guardar</button>
                                    <a href="{{ route('cancelar_anio') }}" class="redondo btn btn-danger"><i class="fas fa-ban"></i> Cancelar</a>
                                </div>
                            </div>
                        </div>
...
@endsection
@section('titulo','Editar Anio Academico')
