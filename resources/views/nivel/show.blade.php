                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="nom_nivel" name="nom_nivel" placeholder="nivel Academico" required="true" value="{{ $nivel->nom_nivel }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="abv_nivel" id="abv_nivel" value="{{$nivel->abv_nivel}}" disabled>
                                        </div>
                            ...
                            <div class="row register-form">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <a href="{{ route('nivel.edit', $nivel->id ) }}" class="redondo btn btn-success btncolorblanco">
