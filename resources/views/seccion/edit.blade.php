...
@section('contenido')
    ...
    <form method="POST" action="{{ route('seccion.update', $seccion->id ) }}">
        @csrf
        @method('PUT')
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="nom_seccion" name="nom_seccion" placeholder="seccion Academico" required="" value="{{ $seccion->nom_seccion }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row register-form">
                                ...
                                <div class="col-md-12"><button type="submit" class="redondo btn btn-info"><i class="fas fa-save"></i> Guardar</button>
                                    <a href="{{ route('cancelar_seccion') }}" class="redondo btn btn-danger"><i class="fas fa-ban"></i> Cancelar</a>
                                </div>
                            </div>
                        </div>
...
@endsection
@section('titulo','Editar Seccion Academico')
